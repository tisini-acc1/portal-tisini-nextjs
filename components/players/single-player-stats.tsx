...
const SinglePlayerStats = ({ fixtureId }: { fixtureId: string }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 bg-white dark:bg-gray-900 rounded-xl shadow-sm">
      {/* Player Bio Header */}
      <header className="flex flex-col md:flex-row gap-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-lg mb-6">
        <div className="flex-shrink-0">
          <div className="w-32 h-32 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center text-4xl font-bold">
            ...
            <div>
              ...
              <div className="mt-3">
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Stats vs <span className="font-medium">{opponent}</span>
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Match result: 0 : 0
                  {/* <span
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
          ...
          <StatCard label="Tackles" value={stats.tackles} />
        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
          ...
          <StatCard label="Aerial Duels" value={stats.aerial} />

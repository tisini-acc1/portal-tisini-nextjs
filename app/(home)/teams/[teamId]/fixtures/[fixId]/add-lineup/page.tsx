...
import SelectRugbyLineup from "@/app/(home)/teams/components/teams/lineups/select-rugby-lineup";
import SelectFootballLineup from "@/app/(home)/teams/components/teams/lineups/select-football-lineup";
